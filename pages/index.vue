  ...
  <section class="theme-default">
    <div class="wrapper">
      <header class="page-header">
        <h1 class="header-name" itemprop="name">Jake Coffman</h1>
        <div class="header-contact-info">
          <p>jake@jakecoffman.com</p>
        </div>
        <div class="title-bar no-print">
          <h2 class="header-title" itemprop="jobTitle">Software Artisan</h2>
          <ul class="icon-links">

            <!-- GitHub link -->
            <li class="icon-link-item">
              <a href="https://github.com/jakecoffman" class="icon-link" itemprop="sameAs">
...
<path id="GitHub" fill-rule="evenodd" clip-rule="evenodd" fill="#D1CECC" d="M14.01,0C6.27,0-0.01,6.28-0.01,14.02
  ...
  c0,1.87-0.02,3.39-0.02,3.84c0,0.37,0.25,0.81,0.96,0.67c5.56-1.86,9.58-7.11,9.58-13.3C28.03,6.28,21.75,0,14.01,0z"></path>
            ...
            <!-- Twitter link -->
            <li class="icon-link-item"><a href="http://twitter.com/nill" class="icon-link" itemprop="sameAs">
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve" width="28">
<path id="Twitter" fill="#D1CECC" d="M14,0C6.27,0,0,6.27,0,14s6.27,14,14,14s14-6.27,14-14S21.73,0,14,0z M20.69,10.57
  ...
  C21.95,9.47,21.37,10.08,20.69,10.57z"></path>
            ...
            <!-- Website link -->
            <li class="icon-link-item"><a href="http://jakecoffman.com" class="icon-link" itemprop="url">
              <svg class="icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 28 28" enable-background="new 0 0 28 28" xml:space="preserve" width="28">
<path id="Website" fill="#D1CECC" d="M14.83,7.6c0.03,0.08,0.03,0.14,0,0.19s-0.08,0.07-0.17,0.07c-0.12,0-0.26-0.01-0.4-0.04
  ...
  C21.31,17.6,21.9,15.93,21.95,14z"></path>
        ...
        <div class="executive-summary" itemprop="description">
          <p>
            I am a professional software developer of 11+ years. I am good at many things but
            especially experienced in web, real-time (games), networking, and writing maintainable code. I have
            professional experience with C++, Python, Java, Ruby, JavaScript, Groovy, C#, and Go. In my
            free time I do Go web apps, games in Unity, and I developed an Android app using gRPC.
          </p>
          <br/>
          <p>
            I have quite a few open source projects, be sure to go see my Github account!
          </p>
        </div>
      ...
      <section class="content-section">
        ...
        <div class="resume-item" itemscope="" itemprop="worksFor" itemtype="http://schema.org/Organization">
          <h3 class="resume-item-title" itemprop="name">World Wide Technology</h3>
          <h4 class="resume-item-details" itemprop="description">Senior Software Developer • 2015 — Present</h4>
          <p class="resume-item-copy">
            I work on various web applications and micro-services doing full stack development.
          <p class="resume-item-copy">
            <b>Technologies:</b> JavaScript (VueJS, NodeJS, AngularJS), Groovy on Grails, Go, HTML/CSS
          </p>
        </div><!-- end of resume-item -->

        <div class="resume-item" itemscope="" itemprop="worksFor" itemtype="http://schema.org/Organization">
          <h3 class="resume-item-title" itemprop="name">Appistry</h3>
          <h4 class="resume-item-details" itemprop="description">Software Developer • 2012 — 2015</h4>
          <p class="resume-item-copy">
            I was hired to work on the proprietary Appistry cloud but quickly switched to working on supporting apps
            that were web based. Also developed a Data Warehouse for the University of Maryland Medical Center to make
            patient data searchable.
          </p>
          <p class="resume-item-copy">
            <b>Technologies:</b> C++, Java (Jersey), HTML/CSS, Python (Django/Mezzanine), Groovy on Grails
          </p>
        </div><!-- end of resume-item -->

        <div class="resume-item" itemscope="" itemprop="worksFor" itemtype="http://schema.org/Organization">
          <h3 class="resume-item-title" itemprop="name">Boeing</h3>
          <h4 class="resume-item-details" itemprop="description">Software Developer/Technical Lead • 2009 — 2012</h4>
          <p class="resume-item-copy">
            For the first year I worked on an instructor station for a flight training system. I did networking and GUI
            design and implementation. After that I moved into a Tech Lead position where I had a team that worked on
            development tools.
          </p>
          <p class="resume-item-copy">
            <b>Technologies:</b> C++, Python (Flask)
          </p>
        </div><!-- end of resume-item -->

        <div class="resume-item" itemscope="" itemprop="worksFor" itemtype="http://schema.org/Organization">
          <h3 class="resume-item-title" itemprop="name">Cerner</h3>
          <h4 class="resume-item-details" itemprop="description">Software Developer • 2006 — 2009</h4>
          <p class="resume-item-copy">I worked on C libraries around security and various security related GUIs.</p>
          <p class="resume-item-copy">
            <b>Technologies:</b> C, VB6
          </p>
        </div><!-- end of resume-item -->
      ...
      <section class="content-section">
        ...
        <div class="resume-item" itemscope="" itemprop="alumniOf" itemtype="http://schema.org/CollegeOrUniversity">
          <h3 class="resume-item-title" itemprop="name">University of Missouri at Rolla</h3>
          <h4 class="resume-item-details group" itemprop="description">Bachelors Degree, Computer Science • 2002 —
            2006</h4>
      ...
      <!--<section class="content-section">-->
        ...
        <!--<div class="resume-item" itemscope="" itemtype="http://schema.org/CreativeWork">-->
          <!--<meta itemprop="creator" content="Homer J. Simpson" itemtype="http://schema.org/Person">-->
          <!--<h3 class="resume-item-title" itemprop="name">donutfinder.io</h3>-->
          <!--<h4 class="resume-item-details" itemprop="description">Founder &amp; Primary Developer • 2012 — Present</h4>-->
          <!--<p class="resume-item-copy">Donut Locator is an open source node/ember app that lets users find donuts within-->
            <!--a defined radius from their home.</p>-->
        <!--</div>-->

        <!--<div class="resume-item" itemscope="" itemtype="http://schema.org/CreativeWork">-->
          <!--<meta itemprop="creator" content="Homer J. Simpson" itemtype="http://schema.org/Person">-->
          <!--<h3 class="resume-item-title" itemprop="name">Springfield Donut Eater's User Group</h3>-->
          <!--<h4 class="resume-item-details" itemprop="description">Co-Founder &amp; Organizer • 2007 — Present</h4>-->
          <!--<p class="resume-item-copy">DEUG is a local monthly meetup in Springfield where we share all the latest tips-->
            <!--and tricks for dat donut lifestyle. I organize the group, and typically eat most of the donuts.</p>-->
        <!--</div>-->
      ...
      <footer class="page-footer">
        <p class="footer-line">Thanks for reading!</p>
      </footer>
    </div>
  </section>
</template>
...
<style lang="scss">
  @import "~assets/_sass/normalize";
  @import "~assets/_sass/mixins";
  @import "~assets/_sass/variables";
  // Generic site base & layout styles
  @import "~assets/_sass/base";
  @import "~assets/_sass/layout";
  // Layouts
  @import "~assets/_sass/resume";
</style>
